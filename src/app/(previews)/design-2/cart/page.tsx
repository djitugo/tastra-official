          ...
          {!ready ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-base mb-10 max-w-md mx-auto leading-relaxed" style={{ color: `${INK}99` }}>
                Mulai dari satu produk yang Anda yakini cocok. Kami percaya pada
                koleksi yang sengaja sedikit.
              </p>
              <Link
                href="/design-2#collection"
            ...
            <div className="grid lg:grid-cols-[1fr_360px] gap-16">
                      ...
                      <div className="mt-6 flex items-end justify-between flex-wrap gap-4">
                        <div className="inline-flex items-center gap-2 border-b pb-1" style={{ borderColor: INK }}>
                          <button
                            ...
                            className="w-9 h-9 flex items-center justify-center text-base hover:opacity-60"
                            aria-label="Kurangi"
                          >
                            −
                          </button>
                          <span className="font-[family-name:var(--font-serif)] text-base min-w-[24px] text-center">
                            {line.qty}
                          </span>
                          <button
                            type="button"
                        ...
                        <div className="flex items-center gap-6">
                          ...
                          <button
                            ...
                            className="text-[11px] tracking-[0.3em] uppercase opacity-60 hover:opacity-100"
                          >
                            Remove
                          </button>
                        </div>
              ...
              <aside className="lg:sticky lg:top-32 h-fit">
                ...
                <Link
                  href="/checkout"
                  className="block w-full text-center mt-8 py-4 text-[12px] tracking-[0.3em] uppercase"
                  style={{ background: INK, color: "#f5f1ea" }}
                >
                  Proceed to Checkout
                </Link>
                <Link
                  href="/design-2#collection"
                  className="block w-full text-center mt-3 py-3 text-[11px] tracking-[0.3em] uppercase border-b"
