...
export default function Design2() {
  ...
  return (
    <>
      <Loader2 />
      <div className="font-[family-name:var(--font-sans)]" style={{ background: CREAM, color: INK }}>
        {/* TOP BAR */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <header className="border-b" style={{ borderColor: `${INK}1A` }}>
          <div className="mx-auto max-w-6xl px-6 lg:px-8 py-6 flex items-center justify-between gap-6">
            ...
            <Link href="/cart" className="text-[13px] tracking-[0.2em] uppercase hover:opacity-60">
              Bag (0)
            </Link>
          </div>
        </header>
        ...
        {/* JOURNAL CTA */}
        <section id="journal" className="border-b" style={{ borderColor: `${INK}1A`, background: CREAM }}>
              ...
              <div className="grid md:grid-cols-3 gap-12">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><a href="#collection" className="hover:opacity-60">Collection</a></li>
                    <li><a href="#philosophy" className="hover:opacity-60">Philosophy</a></li>
                    <li><a href="#journal" className="hover:opacity-60">Journal</a></li>
                  </ul>
                </div>
                <div>
