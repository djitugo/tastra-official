        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8 py-20 md:py-32 grid lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-7">
            ...
            >
              ...
              <a href="#philosophy" className="font-[family-name:var(--font-mono)] text-[11px] tracking-[0.3em] uppercase opacity-60 hover:opacity-100">
                Our Philosophy →
              </a>
            </motion.div>
          </div>
          ...
          >
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} className="absolute inset-0">
              <Image src="/products/uv-protector.webp" alt="The UV Protector" fill priority sizes="(max-width: 1024px) 100vw, 40vw" className="object-contain p-12 md:p-16" />
            </motion.div>
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8 py-24 md:py-32">
          ...
          <Reveal delay={0.2}>
            <div className="space-y-6 text-[15px] leading-[1.95]" style={{ color: `${INK}CC` }}>
              <p>Sebuah ritual harian tidak harus rumit untuk menjadi efektif. Banyak yang berasumsi bahwa kulit yang sehat adalah hasil dari rangkaian panjang — botol demi botol, langkah demi langkah. Kami tidak setuju.</p>
              <p>Kulit, sebagaimana tubuh kita yang lain, hidup dengan ritmenya sendiri. Memberinya terlalu banyak adalah bentuk kebisingan; yang ia butuhkan justru sederhana — bahan yang dipilih dengan alasan, dan disajikan dalam tekstur yang ingin dipakai berulang.</p>
              <p>Karena ritual hanya berfungsi jika ia, sebenarnya, dilakukan.</p>
            </div>
          </Reveal>
        </div>
      </section>
          ...
          <Reveal>
            <div className="grid md:grid-cols-12 gap-8 mb-16">
              ...
              <p className="md:col-span-6 md:col-start-7 text-[15px] leading-[1.9]" style={{ color: `${INK}B3` }}>
                ...
                perannya yang spesifik — tidak lebih, tidak kurang. Jika Anda
                menemukan satu yang Anda sukai, ia kemungkinan akan tinggal
                di rak Anda untuk waktu yang lama.
              </p>
            </div>
          </Reveal>
              ...
              <RevealItem key={p.slug}>
                <Link href={`/design-6/shop/${p.slug}`} className="group block">
                  <motion.div whileHover={{ y: -4 }} transition={{ duration: 0.3, ease: EASE }} className="relative aspect-[3/4] mb-5 overflow-hidden" style={{ background: CREAM_DEEP }}>
                    <Image src={p.images[0]} alt={p.name} fill sizes="(max-width: 1024px) 50vw, 25vw" className="object-contain p-6 md:p-8 transition-transform duration-700 group-hover:scale-105" />
                  </motion.div>
      ...
      <section className="border-b" style={{ borderColor: `${INK}1F`, background: CREAM_DEEP }}>
        <div className="mx-auto max-w-6xl px-6 lg:px-8 py-24 md:py-28">
          ...
          <RevealStagger stagger={0.15} className="grid md:grid-cols-3 gap-12">
            {[
              { roman: "I.", latin: "Centella Asiatica", body: "Daun pegagan — telah lama digunakan dalam tradisi pengobatan kulit di Asia Tenggara untuk efek menenangkan." },
              { roman: "II.", latin: "Niacinamide", body: "Bentuk Vitamin B3 yang stabil; dipilih karena efikasi pada barier kulit dan pori yang membesar." },
              { roman: "III.", latin: "Hyaluronic Acid", body: "Molekul yang mampu mengikat hingga seribu kali bobot air-nya — esensial untuk kelembapan tropis yang seimbang." },
            ].map((x) => (
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8 py-24 text-center">
          ...
          <Reveal delay={0.2}>
            <form className="mt-12 max-w-md mx-auto flex border-b" style={{ borderColor: INK }}>
              <input type="email" placeholder="alamat@email.com" aria-label="Email address" className="flex-1 bg-transparent py-3 text-sm tracking-wider outline-none placeholder:opacity-40" />
              <button type="button" className="font-[family-name:var(--font-mono)] text-[11px] tracking-[0.3em] uppercase px-4 hover:opacity-60">Subscribe</button>
            </form>
          </Reveal>
        </div>
      </section>
