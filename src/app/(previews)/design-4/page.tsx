...
export default function Design4() {
  ...
  return (
    <>
      <Loader4 />
      <div className="font-[family-name:var(--font-jakarta)]" style={{ background: CREAM, color: INK }}>
        {/* PROMO BAR */}
        <div
        ...
        <header className="sticky top-0 z-40 border-b" style={{ background: CREAM, borderColor: `${INK}1A` }}>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-6">
            <Link href="/design-4" className="flex items-center gap-2">
              ...
              <span className="text-xl font-extrabold tracking-wide" style={{ color: GREEN }}>
                TASTRA
              </span>
            </Link>
            <nav className="hidden lg:flex items-center gap-7 text-sm font-semibold" style={{ color: INK }}>
              ...
              <a href="#kategori" className="hover:opacity-60">Kategori</a>
              <a href="#kenapa" className="hover:opacity-60">Kenapa Tastra</a>
              <a href="#kontak" className="hover:opacity-60">Kontak</a>
            </nav>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-20 grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              >
                ...
                <a
                  href="#kenapa"
                  className="inline-flex items-center gap-2 rounded-full px-7 py-3.5 text-sm font-bold border-2 transition-colors hover:bg-white"
              ...
              >
                {ICON_BADGES.map((b, i) => (
                  ...
                  >
                    ...
                    <p className="text-[11px] font-semibold leading-tight" style={{ color: `${INK}B3` }}>
                      {b.label}
                    </p>
                  </motion.div>
                ))}
            ...
            >
              <div
                ...
                style={{ background: `linear-gradient(135deg, ${CREAM} 0%, #ffffff 100%)`, boxShadow: "0 20px 60px rgba(45, 90, 61, 0.15)" }}
              />
              <motion.div
                animate={{ y: [0, -10, 0] }}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <Reveal>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold" style={{ color: INK }}>
                  Cari yang sesuai untukmu
                </h2>
              </div>
            </Reveal>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <Reveal>
              <div className="flex items-end justify-between flex-wrap gap-4 mb-10">
                ...
                <Link href="/shop" className="text-sm font-bold underline underline-offset-4" style={{ color: GREEN }}>
                  Lihat semua →
                </Link>
              </div>
            </Reveal>
                  ...
                  <RevealItem key={p.slug}>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="p-4">
                          <p className="text-[10px] font-bold uppercase tracking-wider mb-1" style={{ color: `${INK}80` }}>
                            {p.category}
                          </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <Reveal>
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-5xl font-extrabold max-w-3xl mx-auto leading-[1.1]">
                  Komitmen kami untuk kulit kamu
                </h2>
              </div>
            </Reveal>
              ...
              {[
                ...
                <RevealItem key={x.label}>
                  <motion.div
                    ...
                    className="text-center p-7 rounded-2xl h-full"
        ...
        <section className="py-16 md:py-20" style={{ background: CREAM }}>
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold mb-4" style={{ color: INK }}>
                Dapatkan info & promo terbaru
              </h2>
              <p className="text-base mb-8" style={{ color: `${INK}99` }}>
                Berlangganan untuk update produk, tips skincare, dan penawaran khusus.
              </p>
              <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-5 py-3.5 rounded-full text-sm border-2 focus:outline-none focus:ring-2 focus:ring-offset-2"
                  style={{ borderColor: `${GREEN}33`, background: "#fff" }}
                />
                <button
                  type="button"
                  className="rounded-full px-7 py-3.5 text-sm font-bold whitespace-nowrap"
                  style={{ background: GREEN, color: CREAM }}
                >
                  Berlangganan
                </button>
              ...
              <div className="grid md:grid-cols-4 gap-10">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    {CATEGORIES.map((c) => (
                      <li key={c.slug}>
                        <Link href={`/shop?cat=${c.slug}`} className="hover:opacity-60">{c.label}</Link>
                      </li>
                    ))}
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><Link href="/about" className="hover:opacity-60">Tentang Tastra</Link></li>
                    <li><Link href="/contact" className="hover:opacity-60">Kontak</Link></li>
                    <li><span className="opacity-50">Cara Pemesanan</span></li>
                    <li><span className="opacity-50">Pengiriman & Pengembalian</span></li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="opacity-50">Senin–Jumat 09.00–17.00</li>
                  </ul>
                </div>
              </div>
