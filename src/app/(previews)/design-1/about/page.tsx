    ...
    <>
      <section className="border-b-2 border-black">
        <div className="w-full max-w-[1700px] mx-auto px-5 sm:px-8 lg:px-16 py-24 md:py-32">
          ...
          <p className="mt-8 max-w-3xl text-lg text-black/70 leading-relaxed">
      ...
      <section className="border-b-2 border-black">
        <div className="w-full max-w-[1700px] mx-auto px-5 sm:px-8 lg:px-16 py-24 md:py-32 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <Reveal>
            <div className="relative aspect-[4/5] border-2 border-black">
              <PlaceholderGraphic bg="#000000" fg="#ffffff" label="Tastra Studio" />
            </div>
          </Reveal>
          <div>
            <Reveal>
            ...
            <Reveal delay={0.15}>
              <p className="mt-6 max-w-3xl text-base md:text-lg text-black/80 leading-relaxed">
              ...
              <p className="mt-4 max-w-3xl text-base md:text-lg text-black/80 leading-relaxed">
      ...
      <section className="bg-black text-white border-b-2 border-black">
        <div className="w-full max-w-[1700px] mx-auto px-5 sm:px-8 lg:px-16 py-28 md:py-40">
          ...
          <RevealStagger stagger={0.1} className="mt-16 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
